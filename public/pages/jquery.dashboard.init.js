...
! function($) {
    ...
    FlotChart.prototype.createPlotGraph = function(selector, data1, data2, data3, labels, colors, borderColor, bgColor) {
        ...
        $.plot($(selector), [{
            ...
            yaxis : {
                axisLabel: "Visites quotidiennes",
                tickColor : '#f5f5f5',
                font : {
                    color : '#bdbdbd'
                }
        ...
        FlotChart.prototype.createCombineGraph = function(selector, ticks, labels, datas) {
            ...
            var options = {
                ...
                yaxis : {
                    axisLabel: "Valeur de point(1000)",
                    tickColor : '#f5f5f5',
                    font : {
                        color : '#bdbdbd'
                    }
        ...
        FlotChart.prototype.init = function() {
            ...
            var combinelabels = ["Dernières 24H", "Derniers 48H", "Difference"];
